...
private val contextDataValue = "value2"
@AutoConfigureObservability
@AutoConfigureWebTestClient
@SpringBootTest(useMainMethod = ALWAYS, classes = [ContextDataProvider2::class])
@ExtendWith(OutputCaptureExtension::class)
private class DemoApplicationTest2(@Autowired private val testClient: WebTestClient) {
...
@TestConfiguration
private class ContextDataProvider2 {
